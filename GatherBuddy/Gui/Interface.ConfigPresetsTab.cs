    ...
    public partial class Interface
    {
        ...
        private void DrawConfigPreset(ConfigPreset preset, bool isDefault)
        {
            ...
            if (!isDefault)
            {
                ...
                if (ImGui.DragInt("Minimum and maximum item".Loc(), ilvl, 0.2f, 1, useGlv ? ConfigPreset.MaxGvl : ConfigPreset.MaxLevel))
                {
            ...
            bool hideGP = false)
        {
            ...
            if (!hideGP)
            {
                ...
                if (ImGui.DragInt("Minimum and maximum GP".Loc(), gp, 1, 0, ConfigPreset.MaxGP))
                {
            ...
            if (action is ConfigPreset.ActionConfigBoon action3)
            {
                ...
                if (ImGui.DragInt("Minimum and maximum boon chance".Loc(), chance, 0.2f, 0, 100))
                {
